import Card from 'react-bootstrap/Card';
  ...
  return (
    <div id='depo'>
      <Card border="primary " id="card3" style={{ width: '30rem' }}>
        <Card.Header style={{fontSize:'x-large',fontWeight:'bold', backgroundImage: 'linear-gradient(to right, red , brown)'}}>Deposit</Card.Header>
        <Card.Body>
 ...
 <button type="submit"  className="w-100 btn btn-lg btn-success all-btn" id="button" onClick={()=>{setResult({display:"none"});setForm({display:"block"});}} >Deposit</button>  
 </div>
