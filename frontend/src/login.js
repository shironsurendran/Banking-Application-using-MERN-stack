...
<Card border="primary " id="card1" style={{ width: '30rem'  }}>
        <Card.Header style={{fontSize:'x-large',fontWeight:'bold', backgroundImage: 'linear-gradient(to right, red , brown)'}} >Login</Card.Header>
        <Card.Body>
          <Card.Text> 
   ...
   {/* <br /> <br /> */}
      ...
      <input type="email" id="inp2" placeholder=" Enter the Email"  value={email} pattern="(?=.*\d)(?=.*[a-z]).{8,}"onChange={(e)=>setEmail(e.target.value)} required/> */}
...
<br /> <br />
 <button  type="submit"  className="w-100 btn btn-lg btn-primary all-btn" id="button" disabled={!isFormFilled}  >Submit</button>
